...
The bxCAN controller provides your application with 28 configurable and scalable filter banks (27-0).   
On models with only one CAN port, all 28 filters are available.   
