...
void setup () {
  Serial.begin (115200) ; // Use PA0/PA1 as STDOUT
  while (!Serial) {
    delay (50) ;
  }
  ...
  // Using PC2/PC3 as FDCAN2 port.
  //settings.mTxPin = PC_3;
  //settings.mRxPin = PC_2;
  // Using PD14/PD15 as FDCAN2 port.
